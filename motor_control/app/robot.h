...
#define HOME_CART_DEC 16000.0f   // mm/s^2 gentler home deceleration
...
#define STRIKE_CONTACT_LEAD_TIME 0.100f // (s) schedule impact this much earlier to compensate latency
