...
#define MAX_CART_DEC 22000.0f    // mm/s^2 softer stop to reduce jerk at end of move
#define HOME_CART_ACC 8000.0f   // mm/s^2 slower home acceleration to reduce oscillation
#define HOME_CART_DEC 8000.0f   // mm/s^2 gentler home deceleration
...
#define STRIKE_CONTACT_LEAD_TIME 0.01f // (s) schedule impact this much earlier to compensate latency
