...
def calibrate_camera_for_intrinsic_parameters(images_prefix):
    ...
    return ret,cmtx, dist

#save camera intrinsic parameters to file
def save_camera_intrinsics(rmse,camera_matrix, distortion_coefs, camera_name):
...
if __name__ == '__main__':
    ...
    rms_error0, cmtx0, dist0 = calibrate_camera_for_intrinsic_parameters(images_prefix) 
    save_camera_intrinsics(rms_error0,cmtx0, dist0, 'camera0') #this will write cmtx and dist to disk
    #camera1 intrinsics
    images_prefix = os.path.join('frames', 'camera1*')
    rms_error1,cmtx1, dist1 = calibrate_camera_for_intrinsic_parameters(images_prefix)
    save_camera_intrinsics(rms_error1, cmtx1, dist1, 'camera1') #this will write cmtx and dist to disk
