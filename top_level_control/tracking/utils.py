...
def read_camera_parameters(camera_id):
    ...
    inf = open(f'camera_calibration/camera_parameters/c' + str(camera_id) + '.dat', 'r')
...
def read_rotation_translation(camera_id, savefolder = 'camera_calibration/camera_parameters/'):
